...
The objective of8 Puzzle Solution Finder Software Screenshot the game is to start from an initial configuration and 
end up in a configuration which the tiles are placed in ascending number order.
